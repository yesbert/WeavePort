...
WeavePort is an embedded backend plugin platform for owner-controlled applications and plugins. Version 0.5.0 targets .NET 10 and is licensed under MIT. The API is evolving; review the exact compatibility matrix before upgrading.
