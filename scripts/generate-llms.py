...
def generate(urls=None):
    ...
    intro = ("# WeavePort\n\n"
             ...
             "The 0.5.0 release includes four core packages plus optional Composition and Gateway server/client packages and an evolving pre-1.0 API. The historical internal distribution is separate. Native processes "
