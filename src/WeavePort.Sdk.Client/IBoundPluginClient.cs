...
public interface IBoundPluginClient : IPluginClient
{
    ...
    IAsyncEnumerable<ReadOnlyMemory<byte>> SourceAsync(string operation, System.Text.Json.JsonElement input, int chunkBytes = 65536, CancellationToken cancellationToken = default) => throw new NotSupportedException("This client does not support binary sources.");
