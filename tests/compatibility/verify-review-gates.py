...
for name in ("Abstractions", "Hosting", "Sdk.Client", "Sdk"):
    shutil.copyfile(root / f"artifacts/packages/WeavePort.{name}.0.1.0-internal.2.nupkg", packages / f"WeavePort.{name}.0.1.0-internal.2.nupkg")
path = packages / "WeavePort.Hosting.0.1.0-internal.2.nupkg"
