...
| Core host packages | Abstractions, Hosting, Sdk.Client, each `0.3.0` | Exact declaration plus actual packed/loaded metadata checks |
| C# author SDK (`dotnet`) | `WeavePort.Sdk` `0.3.0` | Entry-specific declaration, packed metadata and native startup/call checks |
