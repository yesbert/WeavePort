...
Version 0.4.0 targets .NET 10. MIT licensed; third-party packages retain their own licenses. Use a coherent 0.4.0 WeavePort package family. Optional packages are not additional mandatory entries in installation declarations.
