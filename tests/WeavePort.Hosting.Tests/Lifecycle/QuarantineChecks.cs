...
internal static class QuarantineChecks
{
    internal static async Task<int> RunAsync()
    {
        ...
        first.Removal.SetResult(JsonSerializer.SerializeToElement(new
        {
            removed = true
        }));
        await removeFirst;
        ...
        second.Removal.SetResult(JsonSerializer.SerializeToElement(new
        {
            removed = true
        }));
        await retry;
    ...
    private static async Task SharedAccountingAsync()
    {
        ...
        shared.Removal.TrySetResult(JsonSerializer.SerializeToElement(new
        {
            removed = true
        }));
        exclusive.Removal.TrySetResult(JsonSerializer.SerializeToElement(new
        {
            removed = true
        }));
