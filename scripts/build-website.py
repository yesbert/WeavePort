...
GROUPS = {
    ...
    'Build plugins': [('docs/mcp-plugins.md', 'MCP tools'), ('docs/plugin-sdk.md', 'Language SDKs'), ('docs/installed-plugins.md', 'Installed artifacts'), ('docs/package-compatibility.md', 'Compatibility')],
