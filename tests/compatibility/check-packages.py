...
expected_deps = {"WeavePort.Abstractions": set(), "WeavePort.Hosting": {"WeavePort.Abstractions", "WeavePort.Sdk.Client", "Microsoft.Extensions.Logging.Abstractions", "Tomlyn", "Chasm.SemanticVersioning"},
