...
- [x] 1.1 Split client/server assemblies, preserve namespaces and add complete package metadata.
- [x] 1.2 Implement authenticated binding discovery, configurable client transport and bounded server registration helpers.
