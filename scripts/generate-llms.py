...
def generate(urls=None):
    ...
    intro = (
        ...
        "Release 0.8.0 includes four core packages plus optional Composition and Gateway server/client packages, with Python/TypeScript author SDKs 0.4.0. Read the release status and migration notes for changed failure codes, cancellation attribution and exact installation compatibility. Pin source reads to the installed release tag. The historical internal distribution is separate. Native processes "
