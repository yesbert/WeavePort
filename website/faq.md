...
Start here if you are deciding how to make your .NET backend extensible. These answers describe the current 0.2.1 release and link to the detailed contracts.
...
The four public core NuGet packages are released under the [MIT license](../LICENSE). The current version is 0.2.1. Review [packages and compatibility](packages.md) before adopting or upgrading the evolving API.
