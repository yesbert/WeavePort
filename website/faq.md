...
The four public core NuGet packages are released under the [MIT license](../LICENSE). The current version is 0.3.1. Review [packages and compatibility](packages.md) before adopting or upgrading the evolving API.
