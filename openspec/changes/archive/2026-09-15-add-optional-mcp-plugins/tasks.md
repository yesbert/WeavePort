...
- [x] 3.3 Run packed consumer checks and native before/after benchmarks; measure MCP separately with matched workload boundaries and retain failures.
...
- [x] 4.2 Run documentation, public-tree, style, specification and applicable repository verification; synchronize verified requirements.
