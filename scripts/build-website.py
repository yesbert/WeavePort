...
GROUPS = {
    ...
    'Build plugins': [('docs/plugin-sdk.md', 'Language SDKs'), ('docs/installed-plugins.md', 'Installed artifacts'), ('docs/package-compatibility.md', 'Compatibility')],
    ...
    'Operate': [('docs/native-operations.md', 'Recovery runbook'), ('docs/worker-lifecycle.md', 'Worker lifecycle'), ('docs/runtime-diagnostics.md', 'Diagnostics'), ('docs/internal-distribution.md', 'Offline distribution')],
