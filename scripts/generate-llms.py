...
def generate(urls=None):
    ...
    intro = ("# WeavePort\n\n"
             ...
             "The latest verified public core release is 0.4.0; source targets 0.5.0 with optional Composition and Gateway server/client packages and an evolving pre-1.0 API. The historical internal distribution is separate. Native processes "
