...
for mode, low, high in [('trusted', 6000, 9000), ('forkserver', 650, 1150)]:
    run('capacity-' + mode, ['tools/performance/matrix_capacity.py', str(root / ('capacity-' + mode)), '--mode', mode,
        '--low', str(low), '--high', str(high), '--steps', '3', '--seconds', '60', '--workers', '16'])
