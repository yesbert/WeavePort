...
(cd examples/sdk/typescript && npm install --ignore-scripts --force ../../../artifacts/sdk-packages-js/weaveport-sdk-0.3.0.tgz)
...
artifacts/sdk-python/bin/python -m pip install --no-deps --force-reinstall artifacts/sdk-wheel/weaveport_sdk-0.3.0-py3-none-any.whl
