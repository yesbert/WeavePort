...
GUIDES = [
    ...
    ("docs/failure-codes.md", "Failure codes", "Structured outcomes, cleanup and execution uncertainty"),
    ("docs/protocol.md", "Native protocol", "Envelopes, revisions and bounded SDK exchanges"),
    ("docs/security-architecture.md", "Security", "Implemented protection and application responsibilities"),
    ("docs/local-execution.md", "Local execution", "Native process launch, transport and trust"),
    ("docs/source-organization.md", "Source organization", "Feature ownership and dependency direction"),
    ("docs/engineering.md", "Engineering", "Clean code, control flow and meaningful literals"),
    ("docs/dotnet-guidance.md", ".NET guidance", "Framework APIs, memory ownership and measurement"),
    ("docs/continuous-integration.md", "CI", "Qualification and documentation deployment"),
    ("docs/optional-dependencies.md", "Optional dependencies", "Exact dependency and notice review"),
    ("docs/benchmarking.md", "Benchmarking", "Workload scope and evidence interpretation"),
    ("docs/soak-testing.md", "Soak testing", "Supervised workloads and stop controls"),
    ("docs/history.md", "Historical evidence", "How to interpret earlier measurements and delivery records"),
    ("docs/internal-distribution.md", "Historical internal distribution", "Only the frozen 0.1.0-internal.2 offline bundle"),
    ...
    ("sdks/python/README.md", "Python SDK reference", "Handlers, callbacks, cancellation and resources"),
    ("sdks/typescript/README.md", "TypeScript SDK reference", "Handlers, signals, sources and resources"),
    ("examples/mcp/README.md", "MCP example", "Local tools through the packed host"),
    ("examples/reuse/README.md", "Reuse examples", "Registered cleanup in three languages"),
    ("examples/gateway/README.md", "HTTPS example", "Gateway deployment and composition"),
...
def generate(urls=None):
    ...
    index += "".join(f"- [{title}]({link(path)}): Exact reviewed signatures for this checkout\n"
