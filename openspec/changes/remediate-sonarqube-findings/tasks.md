## 1. Regressions and resource safety

- [x] 1.1 Reproduce missing lifetime release and shutdown races with deterministic tests.
- [x] 1.2 Fix host, session, pool and local client ownership and rerun affected suites.
- [x] 1.3 Fix private socket creation and explicit Docker executable selection with focused tests.
